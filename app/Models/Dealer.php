...
class Dealer extends Model
{
    ...
    /**
     * The dealer map for the model.
     *
     * @var array
     */
    protected $dispatchesDealers = [
    ...
    {
        return $this->belongsTo('App\Models\TabSection', 'dealer_id', 'id');
    }


    public function linkFaculty()
    {
        return $this->hasMany('App\Models\LinkFaculty', 'dealer_id', 'id');
    }
