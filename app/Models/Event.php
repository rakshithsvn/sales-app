...
class Event extends Model
{
    ...
    protected $dates = ['deleted_at','event_from_date','event_to_date'];
    ...
    {
        return $this->belongsTo('App\Models\TabSection', 'event_id', 'id');
    }


     public function linkFaculty()
    {
        return $this->hasMany('App\Models\LinkFaculty', 'event_id', 'id');
    }
