...
class Product extends Model
{
    ...
    /**
     * The product map for the model.
     *
     * @var array
     */
    protected $dispatchesProducts = [
    ...
    {
        return $this->belongsTo('App\Models\TabSection', 'product_id', 'id');
    }


    public function linkFaculty()
    {
        return $this->hasMany('App\Models\LinkFaculty', 'product_id', 'id');
    }
