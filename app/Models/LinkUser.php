...
class LinkUser extends Model
{
     ...
     * @var array
     */
    protected $fillable = ['event_id','post_tab_id','event_user_id','active','user_id'];

     protected static $logAttributes = ['event_id','post_tab_id','event_user_id','active','user_id'];
    ...
    {
        return $this->belongsTo('App\Models\EventUser', 'event_user_id', 'id');
    }
