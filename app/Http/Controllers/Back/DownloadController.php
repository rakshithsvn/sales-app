...
class DownloadController extends Controller
{
  ...
  public function viewGraduationRegister(Request $request)
  {
    ...
    $registered_forms = UserPurchase::orderBy('id', 'desc')->paginate(10);

    if (isset($search)) {
      $registered_forms = UserPurchase::where('name', 'like', "%" . $search . "%")->paginate(10);
    }
  ...
  {
    $graduation_details = UserPurchase::where('id', $id)->first();
