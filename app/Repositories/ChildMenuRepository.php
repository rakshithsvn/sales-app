...
class ChildMenuRepository
{
     ...
     */
    public function __construct(ChildMenu $childmenu, Tag $tag, Comment $comment)
    {
        $this->model = $childmenu;
        $this->tag = $tag;
    ...
    public function store($request)
    {
        //dd($request->all());
            ...
            $record_exists = ChildMenu::where('sub_menu_id',$request->sub_menu_id)->where('name',$request->name)->first();
            ...
            if(!$record_exists)
            {
                    ...
                    $childmenu = ChildMenu::create($request->all());
     ...
     * @return void
     */
    public function update($child_menu, $request)
    {
        //dd($faculty);
       
            $record_already_exists = ChildMenu::where('id','!=',$child_menu->id)->where('sub_menu_id',$request->sub_menu_id)->where('name','=',$request->name)->whereNull('deleted_at')->first();
