...
class SubChildMenuRepository
{
     ...
     */
    public function __construct(SubChildMenu $subchildmenu, Tag $tag, Comment $comment)
    {
        $this->model = $subchildmenu;
        $this->tag = $tag;
    ...
    public function store($request)
    {
        // dd($request->all());
            ...
            $record_exists = SubChildMenu::where('child_menu_id',$request->child_menu_id)->where('name',$request->name)->first();
            ...
            if(!$record_exists)
            {
                    ...
                    $subchildmenu = SubChildMenu::create($request->all());
     ...
     * @return void
     */
    public function update($sub_child_menu, $request)
    {
        //dd($faculty);
       
            $record_already_exists = SubChildMenu::where('id','!=',$sub_child_menu->id)->where('child_menu_id',$request->child_menu_id)->where('name','=',$request->name)->whereNull('deleted_at')->first();
           ...
           //dd($record_already_exists);
            ...
            if(!$record_already_exists)
            {
                ...
                $request->merge(['active' => $request->has('active')]);
                $request->merge(['slug' => Str::slug($request->name)]);
                $sub_child_menu->update($request->all());
