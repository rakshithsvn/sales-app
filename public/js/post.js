...
$(document).ready(function(){
 ...
 if(actual_parent_slug != null)
 {
  ...
  if(actual_parent_slug == 'about-us')
  {
   ...
   if(actual_parent_slug == 'services' || actual_parent_slug == 'products')
  {
    $(".icon").show();
  }
...
if(actual_sub_menu != null)
{
 ...
 if(actual_event_date != null)
 {
  $('#event_date').val(actual_event_date);
  // $('#upcoming_event_date').val(actual_event_date);
}
...
if(actual_event_time != null)
 {
    // $('#event_date').val(actual_event_time);
    // $('#upcoming_event_date').val(actual_event_time);
  }
...
if(Id !== '')
{
 $.ajax({
   ...
   dataType: 'json',
      ...
      $("#sub_menu_id").empty();
        $("#sub_menu_id").append( // Append an object to the inside of the select box
        ...
        $("#child_menu_id").empty();
        $("#child_menu_id").append( // Append an object to the inside of the select box
          $("<option></option>") // Yes you can do this.
          .text('--Select--')
          .val('')
          );
 ...
 $.ajax({
   ...
   dataType: 'json',
                ...
                $("#sub_child_menu_id").empty();
                  $("#sub_child_menu_id").append( // Append an object to the inside of the select box
                    $("<option></option>") // Yes you can do this.
                    .text('--Select--')
                    .val('')
                    );
...
$("#tbl_add").click(function(){
 ...
 var lastRowIndex = $("#custom_table tr:last").index() + 1;
    ...
    var ddl = '<tr><td><div class="box box-primary"><div class="box-header with-border"><h3 class="box-title">Title</h3><div class="box-tools pull-right"><button type="button" class="btn btn-box-tool" data-widget="collapse"><i class="fa fa-minus"></i></button></div></div><div class="box-body"><div class="form-group "><input type="text" class="form-control tab_title" id="tab_title['+lastRowIndex+']" name="tab_title['+lastRowIndex+']" value="" required=""></div></div></div><div class="box box-primary"><div class="box-header with-border"><h3 class="box-title">Description</h3><div class="box-tools pull-right"><button type="button" class="btn btn-box-tool" data-widget="collapse"><i class="fa fa-minus"></i></button></div></div><div class="box-body"><div class="form-group "><input type="text" class="form-control tab_image" id="tab_image['+lastRowIndex+']" name="tab_image['+lastRowIndex+']" value="" required=""></div></div></div><div class="box box-primary"><div class="box-header with-border"><h3 class="box-title">Long Description</h3><div class="box-tools pull-right"><button type="button" class="btn btn-box-tool" data-widget="collapse"><i class="fa fa-minus"></i></button></div></div><div class="box-body"><div class="form-group "><textarea class="form-control tab_body" rows="10" id="tab_body['+lastRowIndex+']" name="tab_body['+lastRowIndex+']" ></textarea></div></div></div></td></tr>';
