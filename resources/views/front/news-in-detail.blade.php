          ...
          <div class="blog-entry">
            ...
            <div class="entry-content">
              ...
              <div class="entry-holder">
                {{-- <div class="entry-tags"><span>tags: </span><a href="{{ route('blogs') }}">solar</a><a href="{{ route('blogs') }}">insights</a><a href="{{ route('blogs') }}">systems</a><a href="{{ route('blogs') }}">battery</a><a href="{{ route('blogs') }}">research</a><a href="{{ route('blogs') }}">energy</a></div> --}}
                <!-- End .entry-tags-->
        ...
        <div class="col-12 col-lg-4">
          ...
          <div class="sidebar sidebar-blog">
            ...
            <div class="widget widget-recent-posts">
              ...
              <div class="widget-content">
                <!-- Start .Post-->
                @foreach($recent_news->where('id','!=',$dynamic_content->id) as $key=>$news)
                @if($key<5)
                <div class="post">
                  ...
                  <div class="post-content">
                    ...
                    <div class="post-title"><a href="{{ route('blog',['news_slug'=>$news->slug]) }}">{{ Str::limit($news->title,100) }} </a></div>
                  </div>
                </div>
                @endif
                @endforeach
