    ...
    <div class="modal-content">
      <div class="modal-body">
        <div class="row">
            ...
            <div class="col-md-6">
                <img src="/assets/images/modal.png"  class="img-fluid"/>
            </div>
            <div class="col-md-6 text-center mt-7">
                <div class="sec-title">
                <h2>Download</h2>
            </div>
                <i class="fab fa-android fnt me-3"></i><i class="fab fa-apple fnt"></i>
            </div>
        </div>
      </div>
    </div>
    ...
    <header class="main-header header-style-two">
        ...
        <div class="header-lower">
            <div class="auto-container">    
                ...
                <div class="main-box">
                    <div class="logo-box">
                        <div class="logo"><a href="{{route('home')}}"><img src="/assets/images/logo.jpg" alt="" title=""></a></div>
                    </div>
        ...
        <div class="sticky-header">
            <div class="auto-container">            
                ...
                <div class="main-box">
                    <div class="logo-box">
                        <div class="logo"><a href="/"><img src="/assets/images/logo.jpg" alt="" title=""></a></div>
        ...
        <div class="mobile-menu">
            ...
            <nav class="menu-box">
                <div class="upper-box">
                    <div class="nav-logo"><a href="{{route('home')}}"><img src="/assets/images/logo.jpg" alt="" title=""></a></div>
        ...
        <div class="auto-container">
            ...
            <div class="footer-content wow fadeInUp">
                <div class="text-center">
                    <div class="footer-logo"><a href="#"><img src="/assets/images/logo.jpg" alt=""></a></div>
