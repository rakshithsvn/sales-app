...
@section('button')
    <a class="btn btn-primary" href="{{ route('parent-menus.create') }}"><span class="fa fa-plus" aria-hidden="true"></span> @lang('New Menu')</a>
@endsection
            ...
            <div class="box">
                ...
                <div class="box-body table-responsive">
                    <table id="users" class="table table-striped table-bordered">
                        ...
                        <tbody id="pannel">
                            @include('back.parent-menus.table', compact('parentmenus'))
                        </tbody>
                    </table>
...
<script>
    ...
    var post = (function () {
        var url = '{{ route('parent-menus.index') }}'
        var swalTitle = '@lang('Really destroy parent menu ?')'
