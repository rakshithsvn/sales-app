...
@section('button')
    <a class="btn btn-primary" href="{{ route('link-users.create') }}"><span class="fa fa-plus" aria-hidden="true"></span> @lang('New Link')</a>
@endsection
            ...
            <div class="box">
                ...
                <div class="box-body table-responsive">
                    <table id="users" class="table table-striped table-bordered">
                        ...
                        <tbody id="pannel">
                            @include('back.link-users.table', compact('link_users'))
                        </tbody>
                    </table>
...
<script>
    ...
    var post = (function () {
        var url = '{{ route('link-users.index') }}'
