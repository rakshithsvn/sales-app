...
@section('button')
    <a class="btn btn-primary" href="{{route('address.create')}}"><span class="fa fa-plus" aria-hidden="true"></span> @lang('New Address')</a>
@endsection
        ...
        <div class="box">
         ...
         <div class="box-body table-responsive">
            <table id="users" class="table table-striped table-bordered">
                ...
                <tbody id="pannel">
                    @include('back.address.table', compact('address_details'))
                </tbody>
            </table>
            <div class="pull-right">
                {!! $address_details->render() !!}
            </div>
        </div>
...
<script>
    ...
    var post = (function () {
        ...
        var swalTitle = '@lang('Really destroy Address ?')'
