...
<div class="row">
    ...
    <div class="col-md-8">
        ...
        @include('back.partials.boxinput', [
            ...
            'input' => [
                'name' => 'excerpt',
                'value' => isset($product) ? $product->excerpt : '',
                'input' => 'textarea',
                'rows' =>2,
                'required' => false,
            ],
         ...
         @include('back.partials.boxinput', [
            ...
            'input' => [
                'name' => 'body',
                'value' => isset($product) ? $product->body : '',
                'input' => 'textarea',
                'rows' => 10,
                'required' => true,
            ],
...
@include('back.partials.input', [
    'input' => [
        'name' => 'seo_title',
        'value' => isset($product) ? $product->seo_title : '',
        'input' => 'text',
        'title' => __('META Title'),
        'required' => true,
    ],
...
<div class="image">
    ...
    @lang('Product Image')
    @endslot
    <img id="img" src="@isset($product) {{ $product->image }} @endisset" alt="" class="img-responsive img-fluid">
    @slot('footer')
...
<div class="col-md-8">   
    ...
    @include('back.partials.boxinput', [
        ...
        'input' => [
            'name' => 'active',
            'value' => isset($product) ? $product->active : true,
            'input' => 'checkbox',
            'label' => __('Active'),
        ],
        ])
