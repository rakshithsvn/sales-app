...
<div class="row">
    ...
    <div class="col-md-8">
       ...
       <div class="form-group">
           <select id="parent_menu_id" name="parent_menu_id" value="" class="form-control" required="true">
    ...
    @include('back.partials.boxinput', [
        'box' => [
            'type' => 'box-primary',
            'title' => __('Sub Menu Name'),
        ],
        'input' => [
            'name' => 'name',
            'value' => isset($submenus) ? $submenus->name : '',
            'input' => 'text',
            'required' => true,
        ],
        ])
    ...
    @include('back.partials.boxinput', [
        ...
        'input' => [
            'name' => 'hierarchy',
            'value' => isset($submenus) ? $submenus->hierarchy : '',
            'input' => 'text',
            'required' => true,
        ],
        ])
    ...
    <div class="col-md-4">
        ...
        <div class="form-group">
           ...
           <select id="display_sub_menu" name="display_sub_menu" value="" class="form-control" required="true">
            @foreach($display_sub_menu as $id => $display_sub_menu_id)
            <option value="{{ $id }}" {{($actual_display_menu == $id)? 'selected' : ''}}>{{ $display_sub_menu_id }}</option>
            @endforeach
        </select>
    ...
    @endcomponent
         ...
         <div class="form-group">
                 ...
                 <select id="child_menu" name="child_menu" value="" class="form-control" required="true">
                        @foreach($child_menu as $id => $child_menu_id)
        ...
        @include('back.partials.input', [
            'input' => [
                'name' => 'active',
                'value' => isset($submenus) ? $submenus->active : true,
                'input' => 'checkbox',
                'label' => __('Active'),
            ],
            ])
            ...
            @include('back.partials.input', [
                'input' => [
                    'name' => 'link_active',
                    'id' => 'link_active',
                    'value' => isset($submenus) ? $submenus->link_active : false,
                    'input' => 'checkbox',
                    'label' => __('Active'),
                ],
                ])
             ...
             <div id="external">
                ...
                @include('back.partials.boxinput', [
                    ...
                    'input' => [
                        'name' => 'link',
                        'id' => 'link',
                        'value' => isset($submenus) ? $submenus->link : '',
                        'input' => 'text',
                        'required' => true,
                    ],
                    ])
