...
@section('button')
    <a class="btn btn-primary" href="{{ route('sub-menus.create') }}"><span class="fa fa-plus" aria-hidden="true"></span> @lang('New Sub Menu')</a>
@endsection
            ...
            <div class="box">
                ...
                <div class="box-body table-responsive">
                    <table id="users" class="table table-striped table-bordered">
                        ...
                        <tbody id="pannel">
                            @include('back.sub-menus.table', compact('submenus'))
                        </tbody>
                    </table>
...
<script>
    ...
    var post = (function () {
        var url = '{{ route('sub-menus.index') }}'
        var swalTitle = '@lang('Really destroy sub menu ?')'
