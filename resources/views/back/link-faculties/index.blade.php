...
@section('button')
    <a class="btn btn-primary" href="{{ route('link-faculties.create') }}"><span class="fa fa-plus" aria-hidden="true"></span> @lang('New Link')</a>
@endsection
            ...
            <div class="box">
                ...
                <div class="box-body table-responsive">
                    <table id="users" class="table table-striped table-bordered">
                        ...
                        <tbody id="pannel">
                            @include('back.link-faculties.table', compact('link_faculties'))
                        </tbody>
                    </table>
                    <div class="pull-right">
                    {!! $link_faculties->render() !!}
                    </div>
                </div>
            </div>
            <!-- /.box -->
...
<script>
    ...
    var post = (function () {
        var url = '{{ route('link-faculties.index') }}'
