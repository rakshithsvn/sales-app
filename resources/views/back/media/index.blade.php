...
@section('button')
<a class="btn btn-primary" href="{{route('albums.create')}}"><span class="fa fa-plus" aria-hidden="true"></span> @lang('New Album')</a>
@endsection
            ...
            <table id="users" class="table table-striped table-bordered">
                <thead>
                    <tr>
                        ...
                        <th>@lang('Title')</th>
                        <th>@lang('Image')</th>
                        <th style="display:none;">@lang('Category')</th>
                        <th>@lang('Active')</th>
                        <th>@lang('Creation')</th>
                        <th>@lang('Upload')</th>
                        <th>@lang('Action')</th>
                ...
                <tbody id="pannel">
                    @include('back.media.table', compact('albums'))
                </tbody>
            </table>
...
<script>
    ...
    var post = (function () {
        var url = '{{ route('albums.index') }}'
        var swalTitle = '@lang('Really destroy album ?')'
