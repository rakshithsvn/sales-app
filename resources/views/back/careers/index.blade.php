...
@section('button')
    <a class="btn btn-primary" href="{{ route('careers.create') }}"><span class="fa fa-plus" aria-hidden="true"></span> @lang('New Post')</a>
@endsection
            ...
            <div class="box">
                ...
                <div class="box-body table-responsive">
                    <table id="users" class="table table-striped table-bordered">
                        ...
                        <tbody id="pannel">
                            @include('back.careers.table', compact('careers'))
                        </tbody>
                    </table>
...
<script>
    ...
    var post = (function () {
        var url = '{{ route('careers.index') }}'
        var swalTitle = '@lang('Really destroy career ?')'
