...
@section('button')
    <a class="btn btn-primary" href="{{ route('gallery.create') }}"><span class="fa fa-plus" aria-hidden="true"></span> @lang('New Agenda')</a>
@endsection
            ...
            <div class="box">
                ...
                <div class="box-body table-responsive">
                    <table id="users" class="table table-striped table-bordered">
                        ...
                        <tbody id="pannel">
                            @include('back.gallery.table', compact('project'))
                        </tbody>
                    </table>
...
<script>
    ...
    var post = (function () {
        ...
        var swalTitle = '@lang('Really destroy complete gallery ?')'
