...
@section('button')
    <a class="btn btn-primary" href="{{ route('child-menus.create') }}"><span class="fa fa-plus" aria-hidden="true"></span> @lang('New Child Menu')</a>
@endsection
            ...
            <div class="box">
                ...
                <div class="box-body table-responsive">
                    <table id="users" class="table table-striped table-bordered">
                        ...
                        <tbody id="pannel">
                            @include('back.child-menus.table', compact('childmenus'))
                        </tbody>
                    </table>
...
<script>
    ...
    var post = (function () {
        var url = '{{ route('child-menus.index') }}'
        var swalTitle = '@lang('Really destroy child menu ?')'
