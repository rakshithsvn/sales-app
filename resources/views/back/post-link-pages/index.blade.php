...
@section('button')
    ...
    <a class="btn btn-success" href="{{ route('post-link-pages.link') }}"><span class="fa fa-link" aria-hidden="true"></span> @lang('Copy Link')</a>

   {{-- <a class="btn btn-warning" href="{{ route('post-link-faculties.index') }}">@lang('Link Faculty')</a>--}} 
            ...
            <div class="box">
                ...
                <div class="box-body table-responsive">
                    <table id="users" class="table table-striped table-bordered">
                        ...
                        <tbody id="pannel">
                            @include('back.post-link-pages.table', compact('pages'))
                        </tbody>
...
<script>
    ...
    var post = (function () {
        var url = '{{ route('post-link-pages.index') }}'
        var swalTitle = '@lang('Are you sure want to destroy ?')'
