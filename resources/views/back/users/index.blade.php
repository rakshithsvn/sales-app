...
@section('button')
    <a class="btn btn-primary" href="{{ route('users.create') }}"><span class="fa fa-plus" aria-hidden="true"></span> @lang('New User')</a>
@endsection
            ...
            <div class="box">
                ...
                <div class="box-body table-responsive">
                    <table id="users" class="table table-striped table-bordered">
                        ...
                        <tr>
                            <th>#</th>
                            <th>@lang('Name')<span id="name" class="fa fa-sort pull-right" aria-hidden="true"></span></th>
                            <th>@lang('Email')<span id="email" class="fa fa-sort pull-right"  aria-hidden="true"></span></th>
                            <th>@lang('Role')<span id="role" class="fa fa-sort pull-right" aria-hidden="true"></span></th>
                            <th>@lang('New')</th>
                            <th>@lang('Valid')</th>
