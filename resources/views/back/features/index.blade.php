...
@section('button')
<a class="btn btn-primary" href="{{ route('features.create') }}"><span class="fa fa-plus" aria-hidden="true"></span> @lang('New Feature')</a>
@endsection
                ...
                <table id="users" class="table table-striped table-bordered">
                    <thead>
                        <tr>
                            ...
                            {{-- <th>@lang('Image')<span id="slideIamge" class="fa fa-sort pull-right" aria-hidden="true"></span></th>--}}
                            <th>@lang('Active')<span id="Active" class="fa fa-sort pull-right" aria-hidden="true"></span></th>
                            <th>@lang('Creation')<span id="Creation" class="fa fa-sort pull-right" aria-hidden="true"></span></th>
                            <th>@lang('Action')<span id="Action" class="fa fa-sort pull-right" aria-hidden="true"></span></th>
                        </tr>
                    </thead>

                    <tbody id="pannel">
                        @include('back.features.table', compact('features'))
                    </tbody>
                </table>
