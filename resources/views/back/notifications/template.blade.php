...
<div class="row">
                  ...
                  <thead></thead>
                       ...
                       <tr>
                        ...
                        <div class="box-body">
                          <div class="form-group">
                            ...
                            <!-- <input type="hidden" id="speakers" name="speaker_id[0]" value="{{@$post_tabs[0]->speaker_id}}"/> -->
                          </div></div></div></td>
                         <td>
                           @include('back.partials.boxinput', [
                           'box' => [
                        ...
                        <td>
                         ...
                         <div class="box-body">
                           ...
                           <div class="input-group input-append date datePicker1" id="datePicker1">
                            <input type="text" name="event_date[0]" id="event_date[0]" class="form-control" placeholder="DD/MM/YYYY" value="{{ isset($post_tabs) ? $post_tabs[0]->event_date : '' }}" autocomplete="off">
                   ...
                   <tr value="{{$tabs->id}}">
                    ...
                    <div class="box-body">
                      <div class="form-group">
                          <div class="input-group input-append date datePicker1" id="datePicker1">
                          <input type="text" name="event_date[{{$tabs->id}}][{{$key}}]" id="event_date[{{$tabs->id}}][{{$key}}]" class="form-control" placeholder="DD/MM/YYYY" value="{{ isset($post_tabs) ? $tabs->event_date : '' }}" autocomplete="off">
                          <span class="input-group-addon add-on"><span class="glyphicon glyphicon-calendar"></span></span>
                          </div>
                          </div>
                        </div>
    ...
    <a href="{{route('notifications.index')}}" class="btn btn-default">@lang('Cancel')</a>
