...
<tr>
    ...
    <td align="center"><a href="{{asset('storage/uploads')}}/{{$registered_form->invoice_url}}" target="_blank"><i class="fa fa-download" title="Click to download" aria-hidden="true" style="font-size:15px"></i></a></td> 
