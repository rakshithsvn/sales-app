...
@section('button')
<a href="{{ route('posts.create') }}" class="btn btn-primary"><span class="fa fa-plus" aria-hidden="true"></span> @lang('New Post')</a>
@endsection
        ...
        <div class="box">
            ...
            <div class="box-body table-responsive">
                <table id="users" class="table table-striped table-bordered">
                    <thead>
                        <tr>
                         <th>@lang('Parent Menu')<span id="title" class="fa fa-sort pull-right" aria-hidden="true"></span></th>
...
<script>
    ...
    var post = (function () {
        ...
        var swalTitle = '@lang('Are you sure want to delete ?')'
