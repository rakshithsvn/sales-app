...
<input type="number" name="target_rewards" value="0" class="form-control mb-3" placeholder="Reward Points" required/>    
<label name="Verified">Verified</label><input type="checkbox" name="status" value="{{ $user->id }}" class="ml-3 mb-3" {{ $user->is_verified ? 'checked' : ''}}>
      </div>
